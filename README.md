...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-lk28v48.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-lk28v48.containers.anotherwebservice.com/
...
```
git clone git@github.com:shawsank/container-lk28v48.git
cd container-lk28v48
```
...
```
docker attach container-lk28v48
```
